...
public class Rrf extends InstructionBase {
    ...
    public Rrf(DataMemory dataMemory, StatusRegister statusRegister, WRegister wRegister) {
    ...
    public void execute() {
        ...
        var result = IntUtils.changeBit(register.get() >> 1, 7, statusRegister.getC());

        statusRegister.setC(IntUtils.isBitSet(register.get(), 0));
        target.set(result);
    }
