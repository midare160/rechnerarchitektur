...
public class ThemeManager implements InitializingBean {
    ...
    private static final Map<String, Theme> THEME_MAP;
    ...
    static {
        ...
        THEME_MAP = Collections.unmodifiableMap(map);
    }
    ...
    private void setApplicationStylesheet() {
        var theme = THEME_MAP.get(getCurrentThemeName());
        Application.setUserAgentStylesheet(theme.getUserAgentStylesheet());
    }

    private void applyCurrentStylesheet(Scene scene) {
        var currentTheme = THEME_MAP.get(getCurrentThemeName());
